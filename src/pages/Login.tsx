...
import { IonPage, IonLoading, IonHeader, IonToolbar, IonTitle, IonContent, IonAlert, IonButton, IonIcon, IonToast } from '@ionic/react';
            ...
            <IonHeader>
              <IonToolbar>
                ...
                <IonButton slot="end" fill="clear" onClick={()=>{
                    ...
                    setServ(serv);setPort(port); setOptions(true);
                  ...
                  inputs={[
                    {
                      ...
                      type: 'text',
                      placeholder: 'Логин',
                      value: localStorage.getItem("Stok_data_login") === undefined ? "" : localStorage.getItem("Stok_data_login")
                    },             
                    {
                      name: 'Пароль',
                      type: 'password',
